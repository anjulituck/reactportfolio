...
function Resume() {
    return (
      <section className="resume container-sm v-stack" id="resume">
        ...
        <a className="btn btn-success btn-lg text-uppercase" style={{width:"60%"}}href={resume} download rel="noopener noreferrer" target="_blank" role="button">Download Resume</a>
      </section>
    );
  }
